...
| Status           | Accepted                           |
| Tracking issue   | [rust-lang/goals#757] |
...
*This* goal does not propose to make it a general-purpose arithmetic type,
so does not propose portable rust operations, portable library methods, etc.
